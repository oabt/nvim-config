...
let s:cdFront = {'gui': '#EBEBEB', 'cterm': s:cterm05, 'cterm256': '188'}
let s:cdBack = {'gui': '#262626', 'cterm': s:cterm00, 'cterm256': '234'}
...
let s:cdPopupBack = {'gui': '#303030', 'cterm': s:cterm01, 'cterm256': '236'}
...
let s:cdSearchCurrent = {'gui': '#49545F', 'cterm': s:cterm09, 'cterm256': '238'}
let s:cdSearch = {'gui': '#4C4E50', 'cterm': s:cterm0A, 'cterm256': '238'}
...
let s:cdGray = {'gui': '#707070', 'cterm': s:cterm04, 'cterm256': '08'}
let s:cdViolet = {'gui': '#646695', 'cterm': s:cterm04, 'cterm256': '60'}
let s:cdBlue = {'gui': '#569CD6', 'cterm': s:cterm0D, 'cterm256': '69'}
let s:cdLightBlue = {'gui': '#78CEFC', 'cterm': s:cterm0C, 'cterm256': '117'}
if g:codedark_conservative | let s:cdLightBlue = s:cdFront | endif
let s:cdGreen = {'gui': '#5FAF00', 'cterm': s:cterm0B, 'cterm256': '70'}
let s:cdBlueGreen = {'gui': '#4EC9B0', 'cterm': s:cterm0F, 'cterm256': '43'}
let s:cdLightGreen = {'gui': '#AFFF5F', 'cterm': s:cterm09, 'cterm256': '155'}
let s:cdRed = {'gui': '#F44747', 'cterm': s:cterm08, 'cterm256': '203'}
let s:cdOrange = {'gui': '#F89A74', 'cterm': s:cterm0F, 'cterm256': '173'}
let s:cdLightRed = {'gui': '#F25C5C', 'cterm': s:cterm08, 'cterm256': '167'}
if g:codedark_conservative | let s:cdLightRed = s:cdOrange | endif
let s:cdYellowOrange = {'gui': '#D7BA7D', 'cterm': s:cterm0A, 'cterm256': '179'}
let s:cdYellow = {'gui': '#D7D75F', 'cterm': s:cterm0A, 'cterm256': '185'}
if g:codedark_conservative | let s:cdYellow = s:cdFront | endif
let s:cdPink = {'gui': '#E665DC', 'cterm': s:cterm0E, 'cterm256': '170'}
...
call <sid>hi('MatchParen', s:cdGray, s:cdFront, 'inverse', {})
...
call <sid>hi('Label', s:cdYellowOrange, {}, 'none', {})
call <sid>hi('Operator', s:cdFront, {}, 'none', {})
call <sid>hi('Keyword', s:cdPink, {}, 'none', {})
call <sid>hi('Exception', s:cdPink, {}, 'none', {})

call <sid>hi('PreProc', s:cdLightRed, {}, 'none', {})
call <sid>hi('Include', s:cdLightRed, {}, 'none', {})
call <sid>hi('Define', s:cdLightRed, {}, 'none', {})
call <sid>hi('Macro', s:cdLightRed, {}, 'none', {})
call <sid>hi('PreCondit', s:cdLightRed, {}, 'none', {})
...
call <sid>hi('SpecialChar', s:cdPink, {}, 'none', {})
call <sid>hi('Tag', s:cdPink, {}, 'none', {})
